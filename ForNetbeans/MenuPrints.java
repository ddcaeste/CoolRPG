...
{
    protected static int startMenu() 
    {
        ...
        while (output==0)
        {
            ...
            input = input.trim();
            if (input.equals("1")||input.equals("1.")||input.equals("one")) { scanner2.close(); output = 1; } 
            else if (input.equals("2")||input.equals("2.")||input.equals("two")) { scanner2.close(); output = 2; }
            else if (input.equals("3")||input.equals("3.")||input.equals("three")) { scanner2.close(); output = 3; }         // GEEF LETTER TERUG VAN OPTIE, alles behalve 1234 IS EEN FAAL
            else if (input.equals("4")||input.equals("4.")||input.equals("four")) { scanner2.close(); output = 4; } 
            else if (input.equals("5")||input.equals("5.")||input.equals("five")) { scanner2.close(); output = 5; } 
            else if (input.equals("c4")) { scanner2.close(); output = 1111; }
            else if (input.equals("penis")) { System.out.println("* I'm sure you'd love one"); }
            else if (input.equals("theo")) { System.out.println("* Oh god, please stop violating my game smelly Cypriotic man."); }
            else if (input.equals("joep")) { System.out.println("* Black hole man! Dundundundundundun DUN DUN."); }
            else if (input.equals("dieter")) { System.out.println("* One day, I want to be like you master :D"); }
